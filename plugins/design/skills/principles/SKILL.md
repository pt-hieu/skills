...
| File | Contents |
|------|----------|
| [design-principles.md](references/design-principles.md) | 9 non-negotiable principles: consistency, hierarchy, relationships, interaction model, scanning, data-state weight, escalation, entity grouping, drill-down CTAs |
...
| [formatting.md](references/formatting.md) | Text casing, date format, number conventions |
...
4. **formatting.md** — verify text casing, dates, and numbers against the conventions.
