# Prompting — Research Sources

| Technique | Source | Impact |
|-----------|--------|--------|
| Tool-augmented computation eliminates number hallucination | [MIT Thesis](https://dspace.mit.edu/bitstream/handle/1721.1/162944/sert-dsert-meng-eecs-2025-thesis.pdf) | 100% accuracy on quantitative queries |
| Domain-specific chain-of-thought blueprints | [arxiv 2506.16123](https://arxiv.org/abs/2506.16123) | 63% → 80% accuracy |
| Chain-of-Verification (CoVe) reduces hallucination | [PromptHub](https://www.prompthub.us/blog/three-prompt-engineering-methods-to-reduce-hallucinations) | 23% improvement |
...
| Structured prompting categories improve output quality | [Deloitte](https://www.deloitte.com/us/en/services/consulting/articles/prompt-engineering-for-finance.html) | Industry framework |
| Chain-of-thought with structured data outperforms humans | [Kim et al., arXiv 2407.17866](https://arxiv.org/html/2407.17866v1) | 60% vs 52% human accuracy |
