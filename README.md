...
| `fable-consultant` | Weighs in on one hard question — an honest read, the hardest push-back against the caller's position, and the next thing worth checking. Advisory only. |
